...
scripts='%{_bindir}/koji /usr/sbin/kojid /usr/sbin/kojira /usr/sbin/koji-shadow
         /usr/sbin/koji-gc /usr/sbin/kojivmd /usr/sbin/koji-sweep-db'
...
# alter python interpreter in koji CLI
sed -i 's|#!/usr/bin/python2|#!/usr/bin/python3|' $RPM_BUILD_ROOT%{_bindir}/koji
%endif
%endif
